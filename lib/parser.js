// Lightweight raw-email parser. Deliberately regex-based (no external mail
// library) so it has zero install/network risk during a live demo.

function extractHeader(raw, name) {
  // Matches "Header-Name: value" up to the next header or blank line.
...
function extractBody(raw) {
  // Everything after the first blank line is treated as the body.
